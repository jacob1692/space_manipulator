...
//
// Function : f_dyn_fix( MODEL, Gravity, qdd )
//            Forward dynamics for Fixed Based Robot System
//            calculate the acceleration of the arm ( qdd ) 
//
// Output : qdd  nx1
//
// s.abiko [2008.10]
...
//  matrix_add( 6, 1, a[0], tmp, a[0] );
  matrix_mult( 6, 6, 1, Xup_T, Gravity, a[0] );
