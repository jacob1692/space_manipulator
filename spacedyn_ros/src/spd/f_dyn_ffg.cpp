...
//
// Function : f_dyn_ffg( MODEL, Gravity, vd0, wd0, qdd )
//            Forward dynamics for free-floating base
...
//#include <QDebug>
// --------------------------
void f_dyn_ffg(MODEL &m, double *Gravity, double *vd0, double *wd0, double *qdd){
  ...
  //atrix_mult(6, 6, 1, m.Xup[0], a[0], tmp );
